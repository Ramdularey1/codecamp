...
const Home = () => {
    return(
        ...
        <div className="text-white mt-[100px] flex justify-center items-center flex-col">
            ...
            <p className="text-[20px] mt-[10px] text-center px-4 text-green-700">Unleash your coding potential and embark on a journey to innovate, achieve, master, challenge, and succeed!</p>
        </div>
